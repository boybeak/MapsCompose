...
import com.github.boybeak.map.base.ktx.addGroundOverlay
...
internal class GroundOverlayNode(
    val groundOverlay: IGroundOverlay,
    var onGroundOverlayClick: (IGroundOverlay) -> Unit
) : MapNode {
...
private fun IGroundOverlay.position(position: GroundOverlayPosition) {
